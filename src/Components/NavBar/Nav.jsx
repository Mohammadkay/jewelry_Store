    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-right ms-1 mb-lg-0 ms-auto">
        <li className="nav-item">
          <a  className="nav-link active  mb-0 h5 fs-2 " aria-current="page" href="/#">Home</a>
        </li>
        <li className="nav-item">
          <a className="nav-link active mb-0 h5 fs-2 " aria-current="page" href="/#">About us </a>
        </li>
        <li className="nav-item">
          <a className="nav-link active mb-0 h5 fs-2" aria-current="page" href="/#">Products</a>
        </li>
      ...
      <button className="btn btn-outline- mb-0  h5 fs-2 " type="submit" ><Cart4 color='#5a5b60' size={30} /> </button>
        <button className="btn btn-outline- mb-0   h5 fs-2 " type="submit">Log in  </button>
      </form>
    </div>
  </div>
</nav>
